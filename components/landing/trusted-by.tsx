    ...
    <section className="py-12 md:py-16 bg-gradient-to-b from-muted/30 to-background border-y border-border/50">
      <div className="section-container">
        ...
        <motion.div
          ...
          className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 lg:gap-6"
        >
          {clients.map((client, index) => (
            <motion.div
              ...
              title={client.name}
            >
              <div className="w-12 h-12 md:w-14 md:h-14 flex items-center justify-center text-primary/80 group-hover:text-primary group-hover:scale-110 transition-all duration-300 bg-primary/10 rounded-full p-3 mb-3">
